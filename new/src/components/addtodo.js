...
this.setState({editingState:false})
    ...
    render(){
        ...
        <div className="jumbotron text-center">
            <h1> ADD TODO </h1>
            <input className="form-control" type="text" value={this.state.todo} onChange={this.changeHandler.bind(this)}/>
            <button className="btn btn-primary" onClick={this.addTodo.bind(this)}>Add Todo</button>
            <button className="btn btn-primary" onClick={this.deleteAlll.bind(this)}>Delete All</button>
        </div>    
